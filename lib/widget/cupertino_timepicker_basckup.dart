...
//const Color _kBackgroundColor = Color(0xff16123D);
//
//const TextStyle _kDefaultPickerTextStyle = TextStyle(fontSize: 12, color: Color(0xFFFFFFFF));
//
//TextStyle _themeTextStyle(BuildContext context) {
//  return TextStyle(fontSize: 12, color: Color(0xFFFFFFFF));
//}
//
...
//        TextStyle textStyle = TextStyle(fontSize: 12, color: Color(0xFFFFFFFF));
...
//              child: Text(localizations.timerPickerHour(index), style: TextStyle(color:  Color(0xFFFFFFFF)),),
//            ),
//          ),
//        );
//      }),
...
//                alignment: alignCenterRight,
//                padding: const EdgeInsets.symmetric(horizontal: 2.0),
//                child: Text(localizations.timerPickerMinute(minute), style: TextStyle(color:  Color(0xFFFFFFFF)),),
//              ),
//            ),
//          );
//        } else {
...
//              child: Text(localizations.timerPickerSecond(second), style: TextStyle(color:  Color(0xFFFFFFFF)),),
//            ),
//          ),
//        );
//      }),
